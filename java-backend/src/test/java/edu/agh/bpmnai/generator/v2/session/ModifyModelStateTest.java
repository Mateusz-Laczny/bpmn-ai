...
class ModifyModelStateTest {
    ...
    void returns_END_when_model_response_has_no_tool_calls() {
        ...
        var state = new ModifyModelState(mock(FunctionExecutionService.class), mockApi, aModel, sessionStateStore, chatMessageBuilder, mock(BpmnToStringExporter.class));
    ...
    void adds_error_response_to_conversation_when_called_function_does_not_exist() {
        ...
        var state = new ModifyModelState(mockFunctionExecutionService, mockApi, aModel, sessionStateStore, chatMessageBuilder, mock(BpmnToStringExporter.class));
        var callId = "id";
