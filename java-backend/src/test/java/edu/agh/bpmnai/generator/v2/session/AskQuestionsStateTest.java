...
class AskQuestionsStateTest {
    ...
    void returns_end_and_adds_question_to_conversation_thread_if_ask_question_is_called() {
        ...
        var conversationHistoryStore = new ConversationHistoryStore();
        ...
        assertEquals(callId, lastAddedMessage.toolCallId());
        assertTrue(conversationHistoryStore.getLastMessage().isPresent());
        assertEquals(question, conversationHistoryStore.getLastMessage().get());
    }
}