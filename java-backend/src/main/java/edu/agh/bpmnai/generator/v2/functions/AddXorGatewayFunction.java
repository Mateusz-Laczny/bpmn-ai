...
public class AddXorGatewayFunction {
    public static final String FUNCTION_NAME = "add_xor_gateway";
    public static final ChatFunctionDto FUNCTION_DTO = ChatFunctionDto.builder()
            .name(FUNCTION_NAME)
            .description("Adds a xor gateway to the diagram, where one path has to be chosen from several alternatives. After the gateway, the paths converge on a single point, from which the process is continued.")
