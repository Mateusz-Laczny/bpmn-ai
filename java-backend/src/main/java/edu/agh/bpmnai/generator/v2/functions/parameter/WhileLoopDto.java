...
public record WhileLoopDto(
        ...
        @Description("Task in which the condition is checked, that determines whether the next iteration of the loop will be executed. Does not have to exist in the diagram. In the verb+object naming convention")
        String checkTask,
